    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           .AddJwtBearer(x =>//incluido pra funcionar o jwt
           {
            ...
            services.Configure<VooDatabase>(
               Configuration.GetSection(nameof(VooDatabase)));

            services.AddSingleton<IVooDatabase>(sp =>
                sp.GetRequiredService<IOptions<VooDatabase>>().Value);

            services.AddSingleton<VooServicos>();
        }
